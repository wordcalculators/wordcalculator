...
function applyFilters(cards, category, query, countLabel, emptyState) {
  ...
  if (countLabel) {
    if (!query && category === 'all') {
      ...
      countLabel.textContent = `Showing ${visibleCount} tools in ${categoryLabel}${searchLabel}`;
    }
  }
